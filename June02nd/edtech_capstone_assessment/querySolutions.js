...
db.courses.aggregate([
  ...
  { $unwind: "$instructorDetails" },
  {
    $project: {
      ...
      course_name: 1,
      category: 1,
      instructor_name: "$instructorDetails.instructor_name",
      instructor_rating: "$instructorDetails.rating"
    }
  }
])
...
db.enrollments.aggregate([
  ...
  { $unwind: "$courseDetails" },
  {
    $lookup: {
      from: "instructors",
      localField: "courseDetails.instructor_id",
      foreignField: "instructor_id",
      as: "instructorDetails"
    }
  },
